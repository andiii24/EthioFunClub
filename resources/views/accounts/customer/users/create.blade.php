                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ asset('customer-manager') }}">{{ __('dashboard.Admin') }}</a></li>
                                <li class="breadcrumb-item active">{{ __('dashboard.Customer') }}</li>
                                <li class="breadcrumb-item active">{{ __('dashboard.Register') }}</li>
                            </ol>
                        </div>
                        <h4 class="page-title">{{ __('dashboard.Register_Customer') }}</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
